...
description: Whenever there is a need to review the business side of the application or what we're building. There may also be questions around pricing or requests for gap analysis, etc
model: sonnet
color: orange
